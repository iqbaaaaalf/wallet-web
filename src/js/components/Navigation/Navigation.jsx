          ...
          <div className="card">
            <div className="nav flex-column nav-pills">
              <Link to={'/homepage'}><a id="dashboard-link-home"
                                        className={`nav-link ${this.props.location.pathname ===
                                        '/homepage' ? 'active' : ''}`}
                                        data-toggle="pill" href="#v-pills-home"
                                        aria-controls="v-pills-home"
                                        aria-selected="true">Home</a></Link>
              ...
              '/transfer'
                  ? 'active'
                  : ''}`} data-toggle="pill" href="#v-pills-transfer"
                                        aria-controls="v-pills-transfer"
                                        aria-selected="false">Transfer</a></Link>
              {<Link to={'/topUp'}><a className={`nav-link ${this.props.location.pathname ===
              '/topUp'
                  ? 'active'
                  : ''}`} data-toggle="pill" href="#v-pills-transaction"
                                      aria-controls="v-pills-transaction" aria-selected="false">Top
                Up</a></Link>}
            </div>
          </div>
        </nav>
